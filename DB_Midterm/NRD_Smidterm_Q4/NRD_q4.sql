...
-- Drop user
DROP USER c##NRD_Smidterm_Q4 CASCADE;

-- Create user
CREATE USER c##NRD_Smidterm_Q4 IDENTIFIED BY 7856;

-- Grant access to resources
GRANT connect, resource TO c##NRD_Smidterm_Q4;

-- Provide space for user
ALTER USER c##NRD_Smidterm_Q4 QUOTA 100M ON users;

-- Connect to user
connect c##NRD_Smidterm_Q4/7856;

-- Create spool file
SPOOL C:\NRD_Smidterm_Q4\NRD_q4.txt
...
CREATE SEQUENCE advisor_sequence START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE student_sequence START WITH 10 INCREMENT BY 1;
CREATE SEQUENCE course_sequence START WITH 3 INCREMENT BY 1;

-- Insert data into tables
INSERT INTO ADVISOR VALUES (advisor_sequence.NEXTVAL,'John');

INSERT INTO STUDENT VALUES(student_sequence.NEXTVAL, 'Catherine', DATE '2001-02-11', advisor_sequence.CURRVAL, 'F');

INSERT INTO COURSE VALUES(course_sequence.NEXTVAL, 'Databases I', 3);

INSERT INTO ENROLLMENT VALUES(student_sequence.CURRVAL, course_sequence.CURRVAL, 98);

...
-- Drop user
DROP USER c##NRD_Smidterm_Q2 CASCADE;

-- Create user
CREATE USER c##NRD_Smidterm_Q2 IDENTIFIED BY 7856;

-- Grant access to resources
GRANT connect, resource TO c##NRD_Smidterm_Q2;

-- Provide space for user
ALTER USER c##NRD_Smidterm_Q2 QUOTA 100M ON users;

-- Connect to user
connect c##NRD_Smidterm_Q2/7856;

-- Create spool file
SPOOL C:\NRD_Smidterm_Q2\NRD_q2.txt
